...
const images = [
  "/naujienos/balcia.jpg",
  "/naujienos/balcia1.jpg",
  "/naujienos/balcia2.jpg",
];

export default function BalciaCup2025() {
  ...
  // SEO / Social
  const pageTitle =
    "Puikus žaidimas ir vienybė aikštėje – „Balcia Cup“ 2019/20m. turnyro akimirkos";
  const pageDescription =
    "Smagus sekmadienio rytas, daug įvarčių ir gera nuotaika – mūsų 2019/20m. grupės dalyvavimas „Balcia Cup“ turnyre.";
  const canonicalUrl = "https://www.fakaunas.lt/naujienos/balcia-cup-2025";
  const imageUrl = "https://www.fakaunas.lt/naujienos/balcia1.jpg";
        ...
        >
          ...
          >
            <p className="text-lg text-gray-800 leading-relaxed">
              Puikus žaidimas, daug džiaugsmo ir vienybė aikštėje! 2019/20m. grupės
              futbolininkai dalyvavo „Balcia Cup“ turnyre, kur pademonstravo gražų
              komandinį žaidimą, kovingumą ir tikrą futbolo dvasią.
            </p>

            <p className="text-lg text-gray-800 leading-relaxed">
              <strong>Trenerio Tomo komentaras:</strong> „Labai smagiai praleidome
              sekmadienio rytą. Turnyre pelnėme nemažai įvarčių ir džiaugsmingai juos
              šventėme. Džiaugiuosi, kad vaikai aikštėje elgiasi kaip tikri futbolininkai –
              švenčia įvarčius, palaiko vieni kitus. Turime nuostabius vaikus ir labai
              laukiame kitų turnyrų.“
            </p>
          </motion.div>
