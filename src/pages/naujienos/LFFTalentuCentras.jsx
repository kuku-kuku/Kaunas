...
// Palikta tokia pati struktūra kaip tavo šablone, tik 1 nuotrauka:
const images = [
  '/naujienos/talentai.jpg', // <-- įkelk šį failą į /public/naujienos/
];
...
export default function LFFTalentuCentras() {
  ...
  useEffect(() => {
    // Auto-sukimas paliktas kaip struktūros dalis; su 1 nuotrauka nieko nekeis
  ...
  return (
    <section className="w-full min-h-screen bg-white px-4 sm:px-6 py-12 sm:py-16 flex items-center">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        {/* Karuselė (palikta identiška struktūra), bet su 1 nuotrauka */}
