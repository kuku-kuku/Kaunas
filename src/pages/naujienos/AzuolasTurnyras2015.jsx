...
const images = ["/naujienos/azuolas1.jpg", "/naujienos/azuolas2.jpg"];

export default function AzuolasTurnyras2015() {
  ...
  // SEO / Social
  const pageTitle =
    "FA Kaunas 2015 m. komanda dalyvavo „Ąžuolo“ turnyre";
  const pageDescription =
    "Trenerio Tomo Macelio treniruojama FA Kaunas 2015 m. gimimo komanda dalyvavo „Ąžuolo“ turnyre. Trenerio komentaras apie komandos tikslus, susikaupimą ir tobulėjimo kryptis.";
  const canonicalUrl =
    "https://www.fakaunas.lt/naujienos/azuolo-turnyras-2015";
  const imageUrl = "https://www.fakaunas.lt/naujienos/azuolas1.jpg";
        ...
        >
          ...
          >
            <p className="text-lg text-gray-800 leading-relaxed">
              Trenerio <strong>Tomo Macelio</strong> treniruojama{" "}
              <strong>2015 metų gimimo</strong> komanda dalyvavo{" "}
              <strong>„Ąžuolo“ turnyre</strong>. ⚽️
            </p>

            <p className="text-lg text-gray-800 leading-relaxed">
              <strong>Trenerio komentaras:</strong>
            </p>

            <p className="text-lg text-gray-800 leading-relaxed">
              Komandos tikslas turnyre buvo išlikti susikaupus ir susikoncentravus
              viso turnyro metu ir viską daryti maksimaliomis pastangomis. Manau,
              kad vaikams tai neblogai sekėsi.
            </p>

            <p className="text-lg text-gray-800 leading-relaxed">
              Žinoma, tikiu, kad visada galima pasirodyti geriau, tačiau šios
              dienos turnyru esu patenkintas. Matome vietas, kurias turime
              tobulinti su vaikinais, taigi dirbsime ties jomis.
            </p>

            <p className="text-lg text-gray-800 leading-relaxed">
              Tokie turnyrai yra puiki praktika tiek vaikams, tiek mums,
              treneriams — išbandyti savo jėgas bei įžvelgti, kurios vaikinų
              savybės pasireiškia stipriausiai.
            </p>
          </motion.div>
