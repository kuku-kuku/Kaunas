  ...
  return (
    <div className="space-y-4">
      {blocks.map((b, idx) => {
        ...
        // Jei ateity bus list’ai ar pan. – pridėsim, bet dabar užtenka
        return null;
      })}
    </div>
  );
...
export default function Naujiena() {
  ...
  if (loading) {
    return <section className="w-full min-h-screen bg-white pt-28 px-4">Kraunama...</section>;
  }
    ...
    return (
      <section className="w-full min-h-screen bg-white pt-28 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <Link to="/naujienos" className="inline-block mt-4 text-sky-600 hover:underline font-medium">
            ← Grįžti į naujienas
          </Link>
        </div>
      </section>
    ...
    <section className="w-full min-h-screen bg-white px-4 sm:px-6 pb-12 sm:pb-16 pt-28 md:pt-36 relative z-10">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col items-center gap-6">
          <div className="relative h-64 sm:h-96 md:h-[500px] w-full overflow-hidden rounded-xl shadow-md flex items-center justify-center bg-gray-200">
            {images.length ? (
