...
export default function IBRAFriendlyMatch() {
  ...
  // SEO / Social
  const pageTitle =
    "FA Kaunas auklėtiniai sužaidė draugiškas rungtynes su IBRA Football Academy";
  const pageDescription =
    "Mažieji FA Kaunas auklėtiniai sužaidė draugiškas rungtynes su IBRA Football Academy komanda, siekdami įgauti daugiau patirties. Trenerio Tomo Macelio komentaras apie progresą žaidžiant 4 prieš 4.";
  const canonicalUrl = "https://www.fakaunas.lt/naujienos/friendly-match-ibra";
  const imageUrl = "https://www.fakaunas.lt/naujienos/ibra1.jpg";
    ...
    <section className="w-full min-h-screen bg-white px-4 sm:px-6 pb-12 sm:pb-16 pt-28 md:pt-36 relative z-10">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          >
            Draugiškos rungtynės su IBRA Football Academy
          </motion.div>
          ...
          >
            Mažieji FA Kaunas auklėtiniai sužaidė draugiškas rungtynes su IBRA
            Football Academy
          </motion.h1>
          ...
          >
            <p className="text-lg text-gray-800 leading-relaxed">
              Mažieji <strong>FA Kaunas</strong> auklėtiniai su tikslu įgauti
              daugiau patirties sužaidė draugiškas rungtynes su{" "}
              <strong>IBRA Football Academy</strong> komanda. ⚽️
            </p>

            <p className="text-lg text-gray-800 leading-relaxed">
              <strong>Trenerio Tomo Macelio komentaras:</strong>
            </p>

            <p className="text-lg text-gray-800 leading-relaxed">
              Žaisti 4 prieš 4 tampa vis lengviau. Vaikai pradeda suprasti ką
              kiekvienas turi daryti aikštėje ir bando įvykdyti paskirtas
              užduotis jiems.
            </p>

            <p className="text-lg text-gray-800 leading-relaxed">
              Su kiekvienomis rungtynėmis vis geriau žaidžiame, įmušame vis
              daugiau įvarčių. Labai džiaugiuosi, kad vaikai nori mokytis ir
              tobulėti. Tai yra svarbiausia.
            </p>
          </motion.div>
          ...
          <div className="relative h-64 sm:h-96 md:h-[500px] w-full overflow-hidden rounded-xl shadow-md flex items-center justify-center">
            {images.map((img, index) => (
              <img
                key={index}
                src={img}
                alt="FA Kaunas draugiškos rungtynės nuotrauka"
